...
sudo apt update && sudo apt install unzip build-essential gcc-aarch64-linux-gnu bc flex bison 7zip-standalone kmod bash cpio binutils tar git wget dpkg libssl-dev rpm zstd -y
